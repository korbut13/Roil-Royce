  ...
  return(
    <div className="home">
      ...
      className="home__center">
        ...
        <div className={!visible ? "home__container-img" : "home__container-img container-img-map"}>
          <img src={Car} alt="" className={!visible ? "container-img__img" : "container-img__img img-map"} />
        </div>
